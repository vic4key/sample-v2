...
4. Define social network integration information at `/sample/socials/defines.php`
5. Okay. Take a look the home page at [localhost/sample](http://localhost/sample), the demo page at [localhost/sample/demo](http://localhost/sample/demo), the user/pass for testing is `vic/123` or `test/123` or `user/123` or your social network account
